...
| --------------------------------------------------- | ------------- | ---------------------------------------- | -------- |
| [JaneliaSciComp](https://github.com/JaneliaSciComp) | master        | 31b0a2c7ca348c1eb5351d0408d89db5ac1f307d | single   |
| [JaneliaSciComp](https://github.com/JaneliaSciComp) | dev           | dbc237d555c9f2ca83ea565cdd1ffdcf223a1732 | single   |
...
### **安装JaneliaSciComp   master分支**

安装路径：

```
/usr/nzx-cluster/apps/multifish/pipeline/JaneliaSciComp_multifish/master
```
...
修改配置文件nextflow.config的第16行，指定singularity镜像文件存放路径   （避免再次下载重复的镜像文件）

```
修改前: singularity_cache_dir = getEnvValue("HOME", "/tmp") + "/.singularity_cache"

修改后：singularity_cache_dir = getEnvValue("/GPFS/PUB/multifish_singularity","/GPFS/PUB/multifish_singularity") + "/.singularity_cache"
```
...
```
 module load multifish/multifish_nextflow_21.04.0_master_Janelia  
```
...
/usr/nzx-cluster/apps/multifish/pipeline/JaneliaSciComp_multifish/master/main.nf \
...
```
srun -p q_fat -c 72 /home/yuezhifeng_lab/wangyanmin/scratch60/test_data/multifish_test2/demo_tiny.sh /home/yuezhifeng_lab/wangyanmin/scratch60/test_data/multifish_test2/data/
```
...
### **安装JaneliaSciComp   dev分支**

安装路径：

```
/usr/nzx-cluster/apps/multifish/pipeline/JaneliaSciComp_multifish/dev
```
...
修改配置文件param_utils.nf第106行 开启使用 bigstream

```
修改前: use_bigstream:  false ,

修改后: use_bigstream:  true ,
```
...
```
 module load multifish/multifish_nextflow_23.04.1_dev_Janelia.lua  
```
